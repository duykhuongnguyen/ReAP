...
a1_iden = cvxopt.matrix([1, 0], (2, 1))
a2_iden = cvxopt.matrix([0, 1], (2, 1))

b = cvxopt.matrix(1, (4,1))


constraints1 = [ a1.T*center + np.linalg.norm(a1, 2)*radius <= b[0],
...
constraints2 = [a1_iden.T*center + np.linalg.norm(a1_iden, 2)*radius <= b[0],                        a1_iden.T*center - np.linalg.norm(a1_iden, 2)*radius >= 0, 
                a2_iden.T*center + np.linalg.norm(a2_iden, 2)*radius <= b[1],
                a2_iden.T*center - np.linalg.norm(a2_iden, 2)*radius >= 0]
